  ...
  return (
    <div className='w-screen h-[92vh] flex justify-center items-center flex-wrap p-3 lg:bg-white bg-black'>
      <div className='w-fit flex flex-col items-center gap-3 text-center '>
        ...
        <h1 className='text-4xl font-[montserrat] font-semibold lg:text-black text-white'>{apps.user.email}</h1>
        <h1 className='text-xl font-[montserrat] text-blue-600 mt-2'>{apps.user.role}</h1>
        <h1 className='text-2xl'>{"*".repeat(apps.user.password.length)}</h1>
      </div>
    </div>
  )
}
